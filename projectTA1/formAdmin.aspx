<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formAdmin.aspx.cs" Inherits="projectTA1.formAdmin" %>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <%--tables--%>
    <link rel="stylesheet" href="template/css/dataTables.bootstrap.min.css">
    <link rel="stylesheet" href="template/css/dataTables.bootstrap.css">
    <script src="template/js/chartinator.js"></script>
...
<body>
    <div class="page-container">
                            ...
                            <ul>
                                <li class="dropdown profile_details_drop">
                                    ...
                                    <ul class="dropdown-menu drp-mnu">
                                        ...
                                        <li><a href="formLogin.aspx"><i class="fa fa-sign-out"></i>Logout</a> </li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu">
                <ul id="menu">
                    <li id="menu-home"><a href="formAdmin.aspx"><i class="fa fa-home"></i><span>Home</span></a></li>
                    <li><a href="formKategori.aspx"><i class="fa fa-th-list"></i><span>Data Kategori</span></a></li>
                    <li><a href="formBarang.aspx"><i class=" fa fa-list"></i><span>Data Produk</span></a></li>
                    <li><a href="maps.html"><i class="fa fa-shopping-cart"></i><span>Data Penjualan</span></a></li>
                    <li><a href="maps.html"><i class="fa fa-money"></i><span>Data Pembayaran</span></a></li>

                    <li><a href="maps.html"><i class="fa fa-file-text"></i><span>Laporan</span></a></li>
                    <li id="menu-academico"><a href="formDaftar.aspx"><i class="fa fa-user-plus"></i><span>Daftar</span></a>
                    </li>
                </ul>
            </div>
        </div>
