<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginPembeli.aspx.cs" Inherits="projectTA1.loginPembeli" %>
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" runat="server">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Username is reauired">
                        ...
                        <asp:TextBox ID="txtUser" runat="server" CssClass="input100" placeholder="Type your username"></asp:TextBox>
                        <span class="focus-input100" data-symbol="&#xf206;"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Password is required">
                        <span class="label-input100">Password</span>
                        <asp:TextBox ID="txtPass" runat="server" CssClass="input100" placeholder="Type your password" TextMode="Password"></asp:TextBox>
                        <span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
