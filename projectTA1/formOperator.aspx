<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formOperator.aspx.cs" Inherits="projectTA1.formOperator" %>
...
<body>
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu">
                <ul id="menu">
                    <li id="menu-home"><a href="formOperator.aspx"><i class="fa fa-home"></i><span>Home</span></a></li>
                    <li><a href="maps.html"><i class="fa fa-th-list"></i><span>Data Kategori</span></a></li>
                    <li><a href="maps.html"><i class=" fa fa-list"></i><span>Data Produk</span></a></li>
